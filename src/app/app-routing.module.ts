...
const routes: Routes = [
  ...
  {
    path: 'admin_panel',
    loadChildren: () => import('./pages/dashboards/admin/admin.module').then(m => m.AdminModule),
    canActivate: [AuthAdminGuard]
  },
  {
    path: 'client_panel',
    loadChildren: () => import('./pages/dashboards/client/client.module').then(m => m.ClientModule),
    canActivate: [AuthClientGuard]
  },
  {
    path: 'manager_panel',
    loadChildren: () => import('./pages/dashboards/manager/manager.module').then(m => m.ManagerModule),
    canActivate: [AuthManagerGuard]
  },
  {
    path: 'photographer_panel',
    loadChildren: () => import('./pages/dashboards/photographer/photographer.module').then(m => m.PhotographerModule),
